...
- [`src/sampletagharmonizer/byte_coverage/README.md`](src/sampletagharmonizer/byte_coverage/README.md): read-only byte coverage maps and safety classification.
